				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active"><a href="#">{{$search}} Searching Result)</a></li>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div id="store" class="col-md-9">
						...
						<div class="row">
                            <!-- product -->
                            @foreach($search2 as $b)
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="{{asset('img/'.$b->id_kategori.'/'.$b->foto)}}" alt="{{$b->nama}}">
						...
						<div class="store-filter clearfix">
							<span class="store-qty">Showing {{$search}} results</span>
